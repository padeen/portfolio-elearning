...
<div class="relative flex justify-between items-center my-24 py-12 max-w-5xl space-x-12 rounded">
  <div class="absolute left-72 right-0 h-[40rem] w-[48rem] shadow-md bg-white">
  </div>
  <div class="absolute -left-10 right-0 w-[31rem] z-10">
